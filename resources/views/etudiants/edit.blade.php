...
<div class="container mt-5"> <!-- Ajout de la classe mt-5 pour une marge en haut -->
    <h1 class="text-center">Formulaire pour modifier un étudiant</h1>
        ...
        <div class="col-md-6">
            <form method="POST" action="{{ route('etudiants.update',$etudiant->id) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control" id="adress" name="adress" value="{{$etudiant->adress}}">
                </div>
                ...
                <div class="mb-3">
                    ...
                    @foreach ($villes as $ville)
                        <option value="{{ $ville->ville_id }}" {{ $etudiant->ville_id == $ville->ville_id ? 'selected' : '' }}>{{ $ville->nom }}</option>
                    @endforeach
                    </select>
                </div>
