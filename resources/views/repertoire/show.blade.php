...
<div class="container">
    <div class="col-12 pt-2"> 
        ...
        <hr>
        <p> <a href="/download/{{ $document->fichier }}"> {{ $document->fichier }} </a></p>
       <hr>
...
@if (Auth::user() == $user)
    <div class="row mb-5 justify-content-center">
        <div class="col-3">
            <a href="{{ route('repertoire.edit', $document->id) }}" class="btn btn-primary">{{ __('lang.update') }}</a>
        </div>
        <div class="col-1">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="{{ route('repertoire.delete', $document->id) }}" method="post">
                    @csrf
                    @method('DELETE')
